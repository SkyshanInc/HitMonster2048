...
LD_LIBRARY_PATH=${CXX_GENERATOR_ROOT}/libclang $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py $PWD/action_manager.ini -t spidermonkey -s cocos2d-x -o ../../pokoSanguo/frameworks/runtime-src/libs/bs_bindings/actionmanager-bindings/
